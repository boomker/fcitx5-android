...
git -C "${RIME_DIR}" apply --ignore-whitespace ../../../../fcitx5-rime-full-schema-name.patch || \
    echo "schema name patch already applied or failed"
git -C "${RIME_DIR}" apply --ignore-whitespace ../../../../fcitx5-rime-preedit-cursor-label.patch || \
...
git -C "${FCITX5_DIR}" apply ../../../../../../plugin/rime/src/main/cpp/fcitx5-rime/fcitx5-alt-trigger-v4point1.patch || \
