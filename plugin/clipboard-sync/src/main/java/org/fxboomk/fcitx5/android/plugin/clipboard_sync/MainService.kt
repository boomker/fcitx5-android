...
import org.fxboomk.fcitx5.android.common.ClipboardMetadata
import org.fxboomk.fcitx5.android.common.FcitxPluginService
import org.fxboomk.fcitx5.android.common.PluginMessage
import org.fxboomk.fcitx5.android.common.ipc.FcitxRemoteConnection
import org.fxboomk.fcitx5.android.common.ipc.IClipboardEntryTransformer
import org.fxboomk.fcitx5.android.common.ipc.bindFcitxRemoteService
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.ui.PluginSettingsActivity
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.network.ClipCascadeClient
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.network.ClipCascadeClipboardData
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.network.ClipboardData
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.network.OneClipEventClient
...
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.ui.ClipboardCaptureActivity
import org.fxboomk.fcitx5.android.plugin.clipboard_sync.ui.StoragePathUtils
...
class MainService : FcitxPluginService() {
    ...
    companion object {
        ...
        private const val ACTION_START_SYNC = "org.fxboomk.fcitx5.android.plugin.clipboard_sync.action.START"
        private const val ACTION_RECONNECT_SYNC = "org.fxboomk.fcitx5.android.plugin.clipboard_sync.action.RECONNECT"
        private const val ACTION_PAUSE_SYNC = "org.fxboomk.fcitx5.android.plugin.clipboard_sync.action.PAUSE"
        private const val ACTION_INGEST_CAPTURED_CLIPBOARD = "org.fxboomk.fcitx5.android.plugin.clipboard_sync.action.INGEST_CAPTURED_CLIPBOARD"
