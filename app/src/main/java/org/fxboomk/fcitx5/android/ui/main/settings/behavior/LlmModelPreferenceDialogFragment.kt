...
class LlmModelPreferenceDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val dialog = AlertDialog.Builder(context)
            ...
            .setNeutralButton(R.string.llm_fetch_models, null)
            .create()
    ...
    private fun updateActualIdPreview(rawModel: String) {
        ...
        actualIdView.text = if (normalizedModel.isBlank()) {
            getString(R.string.llm_model_actual_id_empty)
        } else {
            normalizedModel
        }
    }
    ...
    private fun persistValue() {
        ...
        if (modelPreference.callChangeListener(newValue)) {
            ...
            modelPreference.preferenceManager.sharedPreferences?.let { prefs ->
                ...
                val baseUrl = LlmPrefs.currentBaseUrl(prefs, provider)
                LlmPrefs.persistScopedModel(prefs, provider, baseUrl, newValue)
            }
        }
    }
        ...
        lifecycleScope.launch {
            ...
            result.onSuccess { models ->
                ...
                statusView.text = getString(
                    R.string.llm_model_fetch_failed,
    ...
    companion object {
        ...
        private const val STATE_TEXT = "llm_model_text"
