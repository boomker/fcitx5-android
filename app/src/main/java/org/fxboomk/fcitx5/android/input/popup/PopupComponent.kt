...
class PopupComponent :
    ...
    init {
        org.fxboomk.fcitx5.android.input.config.ConfigProviders.addPopupPresetListener {
    ...
    companion object {
        ...
        val popupPresetJson: Map<String, Array<String>>?
            @Synchronized
            get() {
                val snapshot = org.fxboomk.fcitx5.android.input.config.ConfigProviders.readPopupPreset<Map<String, List<String>>>() ?: run {
                    cachedPopupPreset = null
                    return null
                }
